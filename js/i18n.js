(function () {
  ...
  var dict = {
    es: {
      'nav.problem': 'Problema', 'nav.how': 'Cómo funciona', 'nav.coverage': 'Cobertura',
      'nav.proof': 'Resultados', 'nav.faq': 'Preguntas', 'nav.cta': 'Empezar reactivación gratis',
      ...
      'hero.sub': 'Asvelo es el sistema de ingresos de clientes que convierte los leads que ya tienes en citas agendadas — sin comprar ni un lead nuevo.',
      'hero.cta.primary': 'Empezar reactivación gratis', 'hero.cta.secondary': 'Ver el proceso de 5 pasos',
      ...
      'demo.eyebrow': 'Pruébalo', 'demo.title': 'Escucha a Asvelo dar seguimiento en tiempo real.',
      'demo.sub': 'Así suena el seguimiento instantáneo cuando el canal es voz — uno de los que Asvelo usa, junto con SMS, WhatsApp y correo, para contactar a tus leads en minutos. Toca para escuchar una llamada de muestra.',
      'demo.status.ready': 'Listo para llamar', 'demo.status.connecting': 'Conectando…', 'demo.status.connected': 'Conectado',
      ...
      'why2.body': 'Desde el primer contacto hasta la reactivación, cada etapa del recorrido del cliente tiene una acción definida — nadie se queda sin seguimiento.',
      ...
      'coverage.eyebrow': 'Cobertura', 'coverage.title': 'Cada etapa cubierta.',
      'coverage.sub': 'Un solo sistema para todo el ciclo de vida del cliente — busca o filtra para ver qué incluye.',
      'coverage.search': 'Buscar qué incluye…',
      'coverage.filter.all': 'Todo', 'coverage.filter.followup': 'Seguimiento', 'coverage.filter.recovery': 'Recuperación',
      'coverage.filter.retention': 'Retención', 'coverage.filter.reporting': 'Reportes',
      'coverage.item1': 'Seguimiento instantáneo a leads nuevos', 'coverage.item2': 'Nutrición de leads en varios pasos',
      'coverage.item3': 'Respuesta por SMS a llamadas perdidas', 'coverage.item4': 'Confirmaciones y recordatorios de citas',
      'coverage.item5': 'Recuperación de inasistencias y cancelaciones', 'coverage.item6': 'Seguimiento a oportunidades perdidas',
      'coverage.item7': 'Reactivación de leads inactivos', 'coverage.item8': 'Recuperación de clientes anteriores',
      'coverage.item9': 'Recordatorios de recompra', 'coverage.item10': 'Campañas de reseñas y referidos',
      'coverage.item11': 'Automatización de pipeline y enrutamiento de leads', 'coverage.item12': 'Reportes, atribución y optimización',
      'coverage.item1.benefit': 'Para que nadie se enfríe antes de hablar contigo',
      'coverage.item2.benefit': 'Para mantener el interés hasta que estén listos',
      'coverage.item3.benefit': 'Para no perder la cita solo por no contestar',
      'coverage.item4.benefit': 'Para reducir las inasistencias',
      'coverage.item5.benefit': 'Para recuperar el espacio que dejaron libre',
      'coverage.item6.benefit': 'Para que un "no por ahora" no sea un "no" para siempre',
      'coverage.item7.benefit': 'Para cobrar el interés que ya pagaste por conseguir',
      'coverage.item8.benefit': 'Para traer de vuelta a quien ya te compró',
      'coverage.item9.benefit': 'Para que vuelvan antes de buscar a alguien más',
      'coverage.item10.benefit': 'Para convertir clientes contentos en más clientes',
      'coverage.item11.benefit': 'Para que cada lead llegue a la persona correcta',
      'coverage.item12.benefit': 'Para saber qué está funcionando de verdad',
      'coverage.empty': 'Nada coincide con esa búsqueda — prueba con otra palabra.',
      ...
      'proof.eyebrow': 'Resultados', 'proof.title': 'Por qué la velocidad y el seguimiento mueven el número.',
      'proof.cell1': 'Más barato venderle a un cliente actual que adquirir uno nuevo',
      'proof.cell2': 'De los compradores elige al primer negocio que responde',
      'proof.cell3': 'Ventana de respuesta antes de que la conversión caiga fuerte',
      'proof.cell4': 'De las llamadas entrantes a pequeños negocios no se contestan',
      'proof.cell5': 'Cobertura necesaria — los leads no solo llegan en horario laboral',
      'proof.cell6': 'Inversión publicitaria nueva requerida para actuar sobre esto',
      'proof.card1.body': 'Retorno típico citado para programas de retención y reactivación frente a adquisición de clientes nuevos.',
      'proof.source': '— Fuente: verificar antes de publicar',
      'proof.flow.title': 'Un sistema, cada etapa',
      'proof.flow.s1': 'Lead nuevo', 'proof.flow.s2': 'Seguimiento instantáneo', 'proof.flow.s3': 'Agendado',
      'proof.flow.s4': 'Recuperación de inasistencia', 'proof.flow.s5': 'Reactivación',
      'proof.card3.body': 'De las llamadas perdidas en negocios de servicio pequeños y medianos nunca se regresan.',
      ...
      'faq.aside.body': 'Agenda una llamada de 15 minutos y revisamos juntos tu CRM y flujo de leads — sin venta, solo un vistazo a lo que se está fugando.',
      'faq.aside.cta': 'Agendar llamada',
      ...
      'aria.toggleMenu': 'Abrir menú', 'aria.playSample': 'Reproducir llamada de muestra',
    ...
    en: {
      'nav.problem': 'Problem', 'nav.how': 'How it works', 'nav.coverage': 'Coverage',
      'nav.proof': 'Proof', 'nav.faq': 'FAQ', 'nav.cta': 'Start Free Reactivation',
      ...
      'hero.cta.primary': 'Start Free Reactivation', 'hero.cta.secondary': 'See the 5-step process',
      ...
      'demo.eyebrow': 'Try it', 'demo.title': 'Hear Asvelo follow up in real time.',
      'demo.sub': "This is what instant follow-up sounds like over voice — one of the channels Asvelo uses, along with SMS, WhatsApp, and email, to reach your leads in minutes. Tap to hear a sample call.",
      'demo.status.ready': 'Ready to call', 'demo.status.connecting': 'Connecting…', 'demo.status.connected': 'Connected',
      ...
      'why2.body': 'From first contact to reactivation, every stage of the customer journey has a defined next action — nobody falls through.',
      ...
      'coverage.eyebrow': 'Coverage', 'coverage.title': 'Every stage covered.',
      'coverage.sub': "One system for the whole customer lifecycle — search or filter to see what's included.",
      'coverage.search': "Search what's included…",
      'coverage.filter.all': 'All', 'coverage.filter.followup': 'Follow-up', 'coverage.filter.recovery': 'Recovery',
      'coverage.filter.retention': 'Retention', 'coverage.filter.reporting': 'Reporting',
      'coverage.item1': 'New-lead instant follow-up', 'coverage.item2': 'Multi-step lead nurture',
      'coverage.item3': 'Missed-call text-back', 'coverage.item4': 'Appointment confirmations & reminders',
      'coverage.item5': 'No-show & cancellation recovery', 'coverage.item6': 'Lost-opportunity follow-up',
      'coverage.item7': 'Dormant lead reactivation', 'coverage.item8': 'Past-customer win-back',
      'coverage.item9': 'Repeat-purchase reminders', 'coverage.item10': 'Review & referral campaigns',
      'coverage.item11': 'CRM pipeline automation & lead routing', 'coverage.item12': 'Reporting, attribution & optimization',
      'coverage.item1.benefit': "So no one goes cold before they talk to you",
      'coverage.item2.benefit': "To keep interest alive until they're ready",
      'coverage.item3.benefit': 'So a missed call never costs you the appointment',
      'coverage.item4.benefit': 'To cut down on no-shows',
      'coverage.item5.benefit': 'To fill the slot they left open',
      'coverage.item6.benefit': "So a “not now” doesn't become a lost sale",
      'coverage.item7.benefit': 'To collect the interest you already paid to get',
      'coverage.item8.benefit': 'To bring back someone who already bought from you',
      'coverage.item9.benefit': 'So they come back before they look elsewhere',
      'coverage.item10.benefit': 'To turn happy customers into more customers',
      'coverage.item11.benefit': 'So every lead reaches the right person',
      'coverage.item12.benefit': "To know what's actually working",
      'coverage.empty': "Nothing matches that search — try a different word.",
      ...
      'proof.eyebrow': 'Proof', 'proof.title': 'Why speed and follow-up move the number.',
      'proof.cell1': 'Cheaper to sell to an existing customer than acquire a new one',
      'proof.cell2': 'Of buyers go with the first business that responds',
      'proof.cell3': 'Response window before conversion odds drop sharply',
      'proof.cell4': 'Of inbound calls to small businesses go unanswered',
      'proof.cell5': "Coverage needed — leads don't only arrive in business hours",
      'proof.cell6': 'New ad spend required to act on this',
      'proof.card1.body': 'Typical return cited for retention and reactivation programs vs. new customer acquisition.',
      'proof.source': '— Source: verify before publish',
      'proof.flow.title': 'One system, every stage',
      'proof.flow.s1': 'New lead', 'proof.flow.s2': 'Instant follow-up', 'proof.flow.s3': 'Booked',
      'proof.flow.s4': 'No-show recovery', 'proof.flow.s5': 'Reactivation',
      'proof.card3.body': 'Of missed calls at small and mid-size service businesses are never called back.',
      ...
      'faq.aside.body': "Book a 15-minute call and we'll walk through your CRM and lead flow together — no pitch, just a look at what's leaking.",
      'faq.aside.cta': 'Book a call',
      ...
      'aria.toggleMenu': 'Toggle menu', 'aria.playSample': 'Play sample call',
